...
\begin{thm}
    ...
    y = a\cdot x + b
    $$
    gælder, at grafen er en ret linje, hvor $a$ er linjens {\em hældning}, dvs.
    linjen vokser med $a$ enheder, når $x$ vokser med 1 enhed. Punktet
    $(0,\,b)$ er linjens {\em skæringspunkt med $y$-aksen}.
\end{thm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{lin-10}
    \caption{Figur 2.10}
    \label{fig54}
\end{figure}

Men er dette nu dén rette linje, der bedst bestemmer punkterne? Skulle vi måske
...
På fig. 2.11 er en række punkter afsat, og en vilkårlig linje $m$ er tegnet. Desuden er de
